...
void bench_ml_kem_1024_keygen(benchmark::State &state) {
...
void bench_ml_kem_1024_encapsulate(benchmark::State &state) {
    std::array<uint8_t, ml_kem_1024::SEED_D_BYTE_LEN> seed_d{};
    std::array<uint8_t, ml_kem_1024::SEED_Z_BYTE_LEN> seed_z{};
...
void bench_ml_kem_1024_decapsulate(benchmark::State &state) {
    std::array<uint8_t, ml_kem_1024::SEED_D_BYTE_LEN> seed_d{};
    std::array<uint8_t, ml_kem_1024::SEED_Z_BYTE_LEN> seed_z{};
    std::array<uint8_t, ml_kem_1024::SEED_M_BYTE_LEN> seed_m{};
    std::array<uint8_t, ml_kem_1024::PKEY_BYTE_LEN> pubkey{};
...
BENCHMARK(bench_ml_kem_1024_keygen)->Name("ml_kem_1024/keygen")->Unit(benchmark::kMillisecond)
        ->ComputeStatistics("min", compute_min)->ComputeStatistics("max", compute_max);
BENCHMARK(bench_ml_kem_1024_encapsulate)->Name("ml_kem_1024/encap")->Unit(benchmark::kMillisecond)
        ->ComputeStatistics("min", compute_min)->ComputeStatistics("max", compute_max);
