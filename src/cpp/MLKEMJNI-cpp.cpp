...
JNIEXPORT void JNICALL
Java_com_example_pqc_MLKEMJNI_mlkem512Encapsulate(JNIEnv *env, jobject, jbyteArray pk, jbyteArray cipher, jbyteArray shared_key) {
    jbyte *pk_bytes = env->GetByteArrayElements(pk, 0);
...
JNIEXPORT void JNICALL
Java_com_example_pqc_MLKEMJNI_mlkem768Encapsulate(JNIEnv *env, jobject, jbyteArray pk, jbyteArray cipher, jbyteArray shared_key) {
    jbyte *pk_bytes = env->GetByteArrayElements(pk, 0);
...
JNIEXPORT void JNICALL
Java_com_example_pqc_MLKEMJNI_mlkem1024Encapsulate(JNIEnv *env, jobject, jbyteArray pk, jbyteArray cipher, jbyteArray shared_key) {
    jbyte *pk_bytes = env->GetByteArrayElements(pk, 0);
